    ...
    <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
     ...
     <div>
      <div className="lg:w-[570px]">
        <h1 className="text-[20px] leading-[46px] text-headingColor font-[800] md:text-[60px] md:leading-[70px]">
          We help patients live a healthy, longer life.
        </h1>
        <p className="text__para">Empowering Health Through Care and Support
        At our organization, we believe that by providing comprehensive care and support, we empower patients to lead healthier lives and enjoy more years of vitality and well-being</p>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
      <div className="py-[30px] px-5>">
        ...
        <div className="mt-[30px]">
          ...
          <Link to='/doctors' className="w-[44px] h-[44px] rounded-full border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center group hover:bg-primaryColor hover:border-none">
    ...
    <div className="container">
      ...
      <div className="xl:w-[670px]">
        ...
        <ul className="pl-4">
          ...
          <li className="text__para">3.View our physicians who are accepting new patients, use the online scheduling tool to select an appointmnet time.</li>
        </ul>
